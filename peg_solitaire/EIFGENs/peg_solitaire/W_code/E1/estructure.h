...
struct eif_ex_524 {union overhead overhead; char data [8];};
struct eif_ex_552 {union overhead overhead; char data [8];};
...
struct eif_ex_961 {union overhead overhead; char data [1];};
struct eif_ex_963 {union overhead overhead; char data [1];};
