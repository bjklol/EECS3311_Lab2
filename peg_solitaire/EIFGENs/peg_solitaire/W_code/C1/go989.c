...
extern void F989_7391(EIF_REFERENCE);
extern void F989_7392(EIF_REFERENCE);
extern void F989_7393(EIF_REFERENCE);
...
void F989_7391 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 988, Current, 1, 0, 13639);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(4990, "move_down", tr1))(tr1, ui4_1x, ui4_2x);
	RTHOOK(5);
	RTDBGAL(Current, 1, 0x04000000, 1, 0); /* loc1 */
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5195, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(5,1);
...
void F989_7392 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 988, Current, 1, 0, 13640);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(988, Current, 13640);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTJB;
...
void F989_7393 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 988, Current, 1, 0, 13641);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
