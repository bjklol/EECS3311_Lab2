...
static const EIF_TYPE_INDEX egt_13_980 [] = {0xFF01,966,0xFFFF};
...
static const struct desc_info desc_980[] = {
	...
	{EIF_GENERIC(egt_13_980), 13557, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_980), 13558, 0xFFFFFFFF},
	...
	{EIF_GENERIC(egt_15_980), 13564, 0xFFFFFFFF},
};
void Init980(void)
{
	IDSC(desc_980, 0, 979);
	IDSC(desc_980 + 1, 1, 979);
	IDSC(desc_980 + 32, 406, 979);
	IDSC(desc_980 + 36, 404, 979);
}
