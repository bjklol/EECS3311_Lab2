...
static const struct desc_info desc_970[] = {
	...
	{EIF_NON_GENERIC(0x0195 /*202*/), 13461, 32},
	...
	{EIF_GENERIC(egt_13_970), 13473, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_970), 13474, 0xFFFFFFFF},
	{EIF_GENERIC(NULL), 13475, 0xFFFFFFFF},
	{EIF_GENERIC(NULL), 13488, 0xFFFFFFFF},
	{EIF_GENERIC(NULL), 13489, 0xFFFFFFFF},
	{EIF_GENERIC(egt_15_970), 13476, 0xFFFFFFFF},
	{EIF_GENERIC(egt_16_970), 13477, 0},
	{EIF_GENERIC(egt_17_970), 13478, 8},
	{EIF_GENERIC(egt_18_970), 13479, 16},
	{EIF_NON_GENERIC(0x01B3 /*217*/), 13480, 36},
	{EIF_NON_GENERIC(0x01B3 /*217*/), 13481, 40},
	{EIF_NON_GENERIC(0x01B3 /*217*/), 13482, 44},
	{EIF_NON_GENERIC(0x01B3 /*217*/), 13483, 48},
	{EIF_NON_GENERIC(0x01B3 /*217*/), 13484, 52},
	{EIF_NON_GENERIC(0x01B3 /*217*/), 13485, 56},
	{EIF_GENERIC(NULL), 13486, 0xFFFFFFFF},
	{EIF_GENERIC(NULL), 13487, 0xFFFFFFFF},
	{EIF_GENERIC(egt_19_970), 13490, 24},
};
void Init970(void)
{
	IDSC(desc_970, 0, 969);
	IDSC(desc_970 + 1, 1, 969);
	IDSC(desc_970 + 32, 379, 969);
	IDSC(desc_970 + 60, 368, 969);
}
