...
extern EIF_TYPED_VALUE F962_7165(EIF_REFERENCE);
extern void F962_7796(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F962_7165 (EIF_REFERENCE Current)
{
	GTCX
...
void F962_7796 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 961, Current, 0, 7795);
	RTSA(Dtype(Current));
	RTME(Dtype(Current), 0);
	RTLO(2);
	RTMD(0);
