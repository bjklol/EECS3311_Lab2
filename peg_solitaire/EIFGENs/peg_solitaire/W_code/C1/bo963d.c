...
static const EIF_TYPE_INDEX egt_1_963 [] = {0xFF01,1016,962,0xFFFF};
...
static const EIF_TYPE_INDEX egt_14_963 [] = {0xFF01,959,0xFFFF};
...
static const struct desc_info desc_963[] = {
	...
	{EIF_GENERIC(egt_14_963), 13441, 0xFFFFFFFF},
};
void Init963(void)
{
	IDSC(desc_963, 0, 962);
