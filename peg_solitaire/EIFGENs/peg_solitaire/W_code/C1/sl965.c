...
extern EIF_TYPED_VALUE F965_7166(EIF_REFERENCE);
extern EIF_TYPED_VALUE F965_7167(EIF_REFERENCE);
extern EIF_TYPED_VALUE F965_7168(EIF_REFERENCE);
extern void F965_7797(EIF_REFERENCE, int);
...
RTOID (F965_7166)
EIF_TYPED_VALUE F965_7166 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 964, Current, 0, 0, 13447);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(964, Current, 13447);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
RTOID (F965_7167)
EIF_TYPED_VALUE F965_7167 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 964, Current, 0, 0, 13448);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(964, Current, 13448);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
#define Result RTOTRR
	...
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(5206, Dtype(tr1)))(tr1);
	RTNHOOK(1,1);
	Result = (EIF_REFERENCE) RTCCL(tr1);
	RTVI(Current, RTAL);
	RTRS;
...
void F965_7797 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 964, Current, 0, 7796);
	RTSA(dtype);
	RTME(dtype, 0);
	...
	if (RTCEQ(tr1, tr2)) {
		...
		tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(4998, dtype))(Current)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
		tb2 = RTCEQ(tr1, tr2);
	}
	if (tb2) {
...
{
	GTCX
	RTOTS (7166,F965_7166)
	RTOTS (7167,F965_7167)
