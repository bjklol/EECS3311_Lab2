...
static const struct desc_info desc_999[] = {
	...
	{EIF_GENERIC(egt_13_999), 0x00, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_999), 0x00, 0xFFFFFFFF},
	{EIF_GENERIC(egt_15_999), 13707, 0xFFFFFFFF},
	{EIF_GENERIC(egt_16_999), 13706, 0xFFFFFFFF},
	{EIF_GENERIC(egt_17_999), 0x00, 0xFFFFFFFF},
};
void Init999(void)
{
	IDSC(desc_999, 0, 998);
	...
	IDSC(desc_999 + 36, 400, 998);
	IDSC(desc_999 + 39, 408, 998);
}
