...
extern void F998_7423(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F998_7424(EIF_REFERENCE);
extern EIF_TYPED_VALUE F998_7425(EIF_REFERENCE);
extern EIF_TYPED_VALUE F998_7426(EIF_REFERENCE);
...
void F998_7423 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 997, Current, 0, 2, 13668);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(997, Current, 13668);
	RTCC(arg1, 997, l_feature_name, 1, eif_new_type(231, 0x01), 0x01);
	{
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5219, 0xF8000172, 0); /* case */
	RTAR(Current, arg2);
...
void F998_7424 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 997, Current, 3, 0, 13669);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(997, Current, 13669);
	RTIV(Current, RTAL);
	RTE_T
	RTHOOK(1);
	if ((EIF_BOOLEAN) !loc1) {
...
EIF_TYPED_VALUE F998_7425 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 997, Current, 0, 0, 13670);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(997, Current, 13670);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F998_7426 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
